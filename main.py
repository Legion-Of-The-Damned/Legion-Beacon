...
def attach_context_menu(widget):
    widget.bind("<Button-3>", lambda e: show_context_menu(e, widget))
...
add_button = tk.Button(button_frame, text="Добавить вебхук", command=add_embed, bg=theme_entry, fg=theme_fg, bd=0)
